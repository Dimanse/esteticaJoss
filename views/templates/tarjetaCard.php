<div class="tarjeta__card contenedor-medio">
        ...
        <div class="tarjeta__card-informacion">
            ...
            <div class="tarjeta__detalle-informacion">
                <div class="tarjeta__detalle-grid">
                    <div class="tarjeta__icono">
                        ...
                        <p class="tarjeta__nombre"> <?php echo $paciente->email; ?> </p>
                </div>
                <div class="tarjeta__detalle-grid">
                    ...
                    <div class="tarjeta__icono">
                        ...
                        <p class="tarjeta__nombre"><?php echo $tarjeta->codigo; ?></p>
            ...
            <div class="tarjeta__detalle-informacion">
                <div class="tarjeta__detalle-grid">
                    ...
                    <p class="tarjeta__nombre"><?php echo $porcentaje->numero; ?>%</p>
                </div>
                <div class="tarjeta__detalle-grid">
                    ...
                    <div class="tarjeta__icono">
                        ...
                        <p class="tarjeta__nombre"><?php echo $masaje->nombre; ?></p>
            ...
            <div class="tarjeta__detalle-informacion">
                <div class="tarjeta__detalle-grid">
                    ...
                    <p class="tarjeta__nombre"><?php echo $descuento; ?>¢</p>
                </div>
                <div class="tarjeta__detalle-grid">
                    ...
                    <div class="tarjeta__icono">
                        ...
                        <p class="tarjeta__nombre"><?php echo $total; ?>¢</p>
