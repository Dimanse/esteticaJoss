...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <textarea name="observaciones" id="observaciones" cols="30" rows="10" class="formulario__observaciones" placeholder="Observaciones del paciente"><?php echo $paciente->observaciones; ?></textarea>
    </div>
